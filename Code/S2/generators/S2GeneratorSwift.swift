...
class S2GeneratorSwift: S2Generator {
    ...
    func generateToFile(path:String, fromObject ktvObject:KTVObject, rootClassName:String) throws {
        //ToDo: this is why class is not thread-safe
        _rootObject = ktvObject

        var fileString = fileHeader(rootClassName)
    ...
    private func fileHeader(rootClassName:String) -> String {
