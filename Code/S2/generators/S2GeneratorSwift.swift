...
class S2GeneratorSwift: S2Generator {
    ...
    func generateToFile(path:String, fromObject ktvObject:KTVObject, rootClassName:String, needS2Import:Bool) throws {
        //ToDo: this is why class is not thread-safe
        _rootObject = ktvObject

        var fileString = fileHeader(rootClassName, needS2Import:needS2Import)
    ...
    private func fileHeader(rootClassName:String, needS2Import:Bool) -> String {
